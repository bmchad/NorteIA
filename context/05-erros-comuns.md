...
| ⚠️ A tabela `cores` está sem RLS por esquecimento | É **deliberado**: paleta global, sem `user_id`, sem dado de ninguém. Ligar RLS ali quebra o seletor de cores e não protege nada | `30-decisoes-e-licoes.md` D-009 |
